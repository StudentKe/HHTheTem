% !Mode:: "TeX:UTF-8"
%% 请使用 XeLaTeX 编译本文.
% \documentclass{HHIT}% 选项 forprint: 交付打印时添加, 避免彩色链接字迹打印偏淡. 即使用下一行:
% !TEX program = xelatex

\documentclass[forprint]{HHIT}

\begin{document}

%%%%%%% 下面的内容, 据实填空.

% 中文标题和英文标题分别在 "\\"的两侧 “\\” 不可删除！
\title{淮海工学院本科毕业论文(设计)~\LaTeX~模板 \\  Huaihai Institute of Technology Undergraduate thesis (design)~\LaTeX~ template}
%\EnTitle{}
\Collage{计算机工程学院}        %专业班级
% 此“\”后有空格！ 勿删！
\Cmajor{网络工程 \  网络151}    %专业中文名
\author{王佩科}                %作者名字
\Stdnum{2015120729}           %学号
\Teacher{张勇（副教授）} 				%指导教师职称professional ranks and titles
% 此“\”后有空格！ 勿删！
\date{2019年\ 6\ 月}                    % 日期
...
\begin{tabular}{r|r|l}
	\hline\hline
	\multicolumn{2}{l|}{HHIT.tex }       & 主文档. 在其中填写正文.             \\ \hline
	                                & frontmatter.tex & 郑重声明、中英文摘要.               \\ \cline{2-3}
	\raisebox{1em}{includefile 文件夹} &  backmatter.tex & 致谢.                       \\ \hline
	\multicolumn{2}{l|}{figures 文件夹}                  & 存放图片文件.                   \\ \hline
	\multicolumn{2}{l|}{HHIT.cls }             & 定义文档格式的 class file. 不可删除. \\ \hline\hline
\end{tabular}
\end{table}
...
\begin{tabular}{ll}
\hline
   \verb|\documentclass{HHIT}|                     &  毕业论文 \\
   \verb|\documentclass[forprint]{HHIT}|        &  毕业论文打印版 \\
\hline
\end{tabular}
\end{table}
相关解释见下节.
...
本文档下载更新地址: \url{https://github.com/StudentKe/HHTheTem/releases}. 使用之前, 请移步查看是否有更新.

问题反馈及建议, 请联系: whoismango@sina.com.
...
\chapter{更新记录}
2019年 05 月更新: 更新封面为淮海工学院本科毕业论文要求;更新摘要部分;
[希望母校能够早日废弃表格排版这种糟粕，使得文档更加优雅]
[0.0.1版本,作者精力有限，对latex掌握并不熟练，遗留很多零散的命令未整理]
[0.0.2 "江苏海洋大学"版本,等作者上了研再说。。]
